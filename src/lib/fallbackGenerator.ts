...
Career Path AI maps high-paying, future-proof positions where tech demand is rising exponentially! Which of these triggers your passion most?`;
  } else {
    return `Hi **${profile.name || "there"}**! I am **Career Path AI**, your premium Academic Counselor.
